...
class RestController extends CI_Controller
{
    ...
    public function __construct($config = 'rest')
    {
        ...
        $this->lang->load('rest_controller', $language, false, true, __DIR__ . '/codeigniter-restserver-master/');
    ...
    private function get_local_config($config_file)
    {
        if (file_exists(APPPATH.'config/'.$config_file.'.php')) {
            ...
            if (file_exists(__DIR__ . 'RestController.php/' .$config_file.'.php')) {
                $config = [];
                include __DIR__ . 'RestController.php/' .$config_file.'.php';
